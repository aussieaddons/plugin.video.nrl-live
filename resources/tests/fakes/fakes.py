...
class FakePlugin(object):
    ...
    def addDirectoryItems(self, handle, items, totalItems=0):
        for item in items:
            self.addDirectoryItem(handle, item[0], item[1], item[2] if len(item) == 3 else False, totalItems)
...
SIGNON_FAIL_REDIRECT_URL = 'https://signon.telstra.com.au/login?status=error&errorcode=3&eun=mrfoobar&goto=https%3A%2F%2Ftapi.telstra.com%2Fv1%2Fsso%2Fidpcallback%3Fcbs%3Dfoobar123abc%26app_name%3DOne+Place+Portal'
